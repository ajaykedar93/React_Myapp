    ...
    <>
      ...
      <Modal show={showEdit} onHide={()=>setShowEdit(false)} centered dialogClassName="edit-modal" contentClassName="pop edit-pop" backdrop="static">
        ...
        <Form onSubmit={handleSave} className="edit-form">
          ...
          <Modal.Footer className="pop-f edit-foot"><Button variant="light" size="sm" className="fbtn" onClick={()=>setShowEdit(false)}>Cancel</Button><Button type="submit" size="sm" disabled={loading||otpStep!=='none'} className="fbtn pri">{loading?<Spinner size="sm"/>:'Save'}</Button></Modal.Footer>
        </Form>
      </Modal>
