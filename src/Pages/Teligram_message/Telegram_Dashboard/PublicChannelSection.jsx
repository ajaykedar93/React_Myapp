...
import { ThreeDotsVertical, XLg, Globe, PencilSquare, Trash, Share, Link45deg, Camera, Search, CheckLg, ExclamationTriangle, PencilFill } from 'react-bootstrap-icons';
...
export default function PublicChannelSection({ channels=[], onUpdated, onDeleted, onOpen, showCenterToast }){
 ...
 .logo-block{display:flex;flex-direction:column;align-items:center;gap:7px;margin-bottom:16px}.logo-circle{width:76px;height:76px;border-radius:50%;border:1.5px dashed #cbd5e1;background:#f8fafc;display:flex;align-items:center;justify-content:center;overflow:hidden;cursor:pointer}.logo-circle img{width:100%;height:100%;object-fit:cover}.logo-below{font-size:10px;font-weight:700;color:#64748b;display:flex;align-items:center;gap:4px;cursor:pointer}
