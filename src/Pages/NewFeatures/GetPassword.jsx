...
export default function GetPassword() {
    ...
    s.innerHTML = `
      ...
      *{
      ...
      body{
        ...
        background:
          radial-gradient(circle at top left, rgba(14,165,233,.08), transparent 25%),
          radial-gradient(circle at top right, rgba(30,58,138,.08), transparent 25%),
      ...
      .pw-card{
        border:1.5px solid rgba(30,58,138,.22);
        border-radius:16px;
        padding:12px;
        box-shadow:0 8px 18px rgba(14,31,76,.06);
        background:#fff;
      }
  ...
  return (
    <div className="pm-page">
      <div className="container-fluid pm-wrap px-2 px-md-3 py-3" style={{ minHeight: "100dvh" }} aria-hidden={!!editItem}>
        {/* Header */}
        <div className="glass pm-header-box mb-3">
          <div className="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-3">
            <div className="d-flex align-items-center gap-3">
              <div className="pm-logo">PW</div>
              <div>
                <h4 className="m-0 brand-title pm-top-title">Saved Passwords</h4>
                <div className="text-muted pm-sub">Search, edit, copy, and manage securely</div>
              </div>
            </div>

            <div className="text-sm-end">
              <div className="text-muted small">Total</div>
              <div className="pm-total">{activeCount}</div>
            </div>
          </div>
        </div>

        {/* Filters */}
        <div className="glass pm-filter-box mb-3">
        ...
        {/* CONTENT */}
        <div className="glass pm-table-box">
          {loadingTable && (
                ...
                <table className="table table-hover m-0 align-middle">
                  <thead>
                    <tr>
                      ...
                      <th style={{ minWidth: 170 }}>Username</th>
                      <th style={{ minWidth: 220 }}>Password</th>
                      <th style={{ minWidth: 220 }}>Notes</th>
                      <th className="text-end" style={{ minWidth: 190 }}>Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    {pageItems.length === 0 ? (
          ...
          {!loadingTable && items.length > 0 && (
            <div className="d-flex align-items-center justify-content-between p-2 p-sm-3 flex-wrap gap-2">
              <div className="text-muted pm-pagination-text">
        ...
        {busy && (
          ...
          >
            <div className="bg-white rounded-4 shadow p-3 text-center d-flex flex-column align-items-center">
              <LoadingSpiner />
              <div className="text-muted mt-2 small">Working…</div>
            </div>
          </div>
        )}
