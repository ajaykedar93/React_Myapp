...
const TOTALS_API =
  "https://express-backend-myapp.onrender.com/api/monthly-summary/total";
const LIST_API =
  "https://express-backend-myapp.onrender.com/api/monthly-summary";
    ...
    try {
      ...
      if (!listRes.ok) {
        ...
        const count = Array.isArray(groups)
          ? groups.reduce(
              (sum, g) =>
                sum + (Array.isArray(g.transactions) ? g.transactions.length : 0),
              0
            )
          : 0;
        setTxCount(count);
  ...
  return (
    <>
      <style>{`
        ...
        /* ✅ HARD RESET (prevents horizontal stretch / gaps) */
        html, body {
          width: 100%;
          max-width: 100%;
          margin: 0 !important;
        ...
        *{ box-sizing: border-box; min-width: 0; }
        ...
        /* ✅ EDGE-TO-EDGE wrapper (no padding) */
        .wrap{
          min-height: 100dvh;
          width: 100%;
          background: var(--bg);
        ...
        /* ✅ Full width panel (no max-width on mobile) */
        .card-pro{
          width: 100%;
          max-width: 100%;
          background: var(--surface);
          border: 1px solid var(--border);
          border-radius: 0;         /* ✅ mobile edge-to-edge: no rounding */
          overflow: visible;
          box-shadow: none;         /* ✅ no floating card on mobile */
        }

        /* Optional: keep desktop “card look” */
        @media (min-width: 768px){
          .wrap{
            display:flex;
            align-items:center;
            justify-content:center;
            padding: 18px;          /* desktop padding only */
          }
          .card-pro{
            max-width: 1000px;
            border-radius: 20px;
        ...
        /* ✅ body padding: mobile side padding remove */
        .card-pro__body{
          padding: 12px;     /* small inner padding (content readable) */
        }
        @media (max-width: 576px){
          .card-pro__body{ padding-left: 10px; padding-right: 10px; }
        }
        ...
        @media (min-width:576px){
          .balance-body{ grid-template-columns:repeat(3,1fr); }
        }
      ...
      <div className="wrap">
        <div className="card-pro">
          <div className="card-pro__head">
            ...
            <p className="card-pro__sub">
              Select a month to view totals and your net balance.
            </p>
          </div>
            ...
            <form onSubmit={loadData} className="mb-2">
              <div className="form-grid">
                ...
                <div className="desktop-month">
                  <label htmlFor="monthSel" className="form-label">
                    Month
                  </label>
                  <select
                    id="monthSel"
                ...
                <div>
                  <label htmlFor="yearInp" className="form-label">
                    Year
                  </label>
                  <input
                    id="yearInp"
                ...
                <div>
                  <button className="btn-brand" disabled={!canSubmit || loading}>
              ...
              <>
                  ...
                  <div className="metric metric--debit">
                    ...
                    <div className="metric__value">
                      {loading ? (
                        ...
                        rupee.format(Number(totals.debit || 0))
                      ) : (
                        "--"
                      )}
                    </div>
                  ...
                  <div className="metric metric--credit">
                    ...
                    <div className="metric__value">
                      {loading ? (
                        ...
                        rupee.format(Number(totals.credit || 0))
                      ) : (
                        "--"
                      )}
                    </div>
                ...
                <div className="balance-strip">
                  <div className="balance-head">
                    ...
                    {!loading && totals && <span className="tag">Period: {monthLabel} {year}</span>}
                  </div>
        ...
        >
          <div className="mmodal-card" onClick={(e) => e.stopPropagation()}>
            <div className="mmodal-head">
              ...
              <button className="btn-outline" onClick={() => setMonthModalOpen(false)}>
                Close
              </button>
            </div>
